...
{  
    if (YahooCode ==0){text_layer_set_text(IconLayer,"(");} //tornado
    else if (YahooCode ==1){text_layer_set_text(IconLayer,"O");} //tropical storm
    else if (YahooCode ==2){text_layer_set_text(IconLayer,"(");} //hurricane
    else if (YahooCode ==3){text_layer_set_text(IconLayer,"O");} //severe thunderstorms
    else if (YahooCode ==4){text_layer_set_text(IconLayer,"O");} //thunderstorms
    else if (YahooCode ==5){text_layer_set_text(IconLayer,"Q");} //mixed rain and snow
    else if (YahooCode ==6){text_layer_set_text(IconLayer,"Q");} //mixed rain and sleet
    else if (YahooCode ==7){text_layer_set_text(IconLayer,"Q");} //mixed snow and sleet
    else if (YahooCode ==8){text_layer_set_text(IconLayer,"X");} //freezing drizzle
    else if (YahooCode ==9){text_layer_set_text(IconLayer,"Q");} //drizzle
    else if (YahooCode ==10){text_layer_set_text(IconLayer,"X");} //freezing rain
    else if (YahooCode ==11){text_layer_set_text(IconLayer,"Q");} //showers
    else if (YahooCode ==12){text_layer_set_text(IconLayer,"Q");} //showers
    else if (YahooCode ==13){text_layer_set_text(IconLayer,"U");} //snow flurries
    else if (YahooCode ==14){text_layer_set_text(IconLayer,"U");} //light snow showers
    else if (YahooCode ==15){text_layer_set_text(IconLayer,"U");} //blowing snow
    else if (YahooCode ==16){text_layer_set_text(IconLayer,"U");} //snow
    else if (YahooCode ==17){text_layer_set_text(IconLayer,"X");} //hail
    else if (YahooCode ==18){text_layer_set_text(IconLayer,"Q");} //sleet
    else if (YahooCode ==19){text_layer_set_text(IconLayer,"M");} //dust
    else if (YahooCode ==20){text_layer_set_text(IconLayer,"M");} //foggy
    else if (YahooCode ==21){text_layer_set_text(IconLayer,"M");} //haze
    else if (YahooCode ==22){text_layer_set_text(IconLayer,"M");} //smoky
    else if (YahooCode ==23){text_layer_set_text(IconLayer,"F");} //blustery
    else if (YahooCode ==24){text_layer_set_text(IconLayer,"F");} //windy
    else if (YahooCode ==25){text_layer_set_text(IconLayer,"U");} //cold
    else if (YahooCode ==26){text_layer_set_text(IconLayer,"H");} //cloudy
    else if (YahooCode ==27){text_layer_set_text(IconLayer,"I");} //mostly cloudy (night)
    else if (YahooCode ==28){text_layer_set_text(IconLayer,"H");} //mostly cloudy (day)
    else if (YahooCode ==29){text_layer_set_text(IconLayer,"I");} //partly cloudy (night)
    else if (YahooCode ==30){text_layer_set_text(IconLayer,"H");} //partly cloudy (day)
    else if (YahooCode ==31){text_layer_set_text(IconLayer,"C");} //clear (night)
    else if (YahooCode ==32){text_layer_set_text(IconLayer,"B");} //sunny
    else if (YahooCode ==33){text_layer_set_text(IconLayer,"I");} //fair (night)
    else if (YahooCode ==34){text_layer_set_text(IconLayer,"H");} //fair (day)
    else if (YahooCode ==35){text_layer_set_text(IconLayer,"Q");} //mixed rain and hail
    else if (YahooCode ==36){text_layer_set_text(IconLayer,"J");} //hot
    else if (YahooCode ==37){text_layer_set_text(IconLayer,"O");} //isolated thunderstorms
    else if (YahooCode ==38){text_layer_set_text(IconLayer,"O");} //scattered thunderstorms
    else if (YahooCode ==39){text_layer_set_text(IconLayer,"O");} //scattered thunderstorms
    else if (YahooCode ==40){text_layer_set_text(IconLayer,"Q");} //scattered showers
    else if (YahooCode ==41){text_layer_set_text(IconLayer,"U");} //heavy snow
    else if (YahooCode ==42){text_layer_set_text(IconLayer,"U");} //scattered snow showers
    else if (YahooCode ==43){text_layer_set_text(IconLayer,"U");} //heavy snow
    else if (YahooCode ==44){text_layer_set_text(IconLayer,"H");} //partly cloudy
    else if (YahooCode ==45){text_layer_set_text(IconLayer,"O");} //thundershowers
    else if (YahooCode ==46){text_layer_set_text(IconLayer,"U");} //snow showers
    else if (YahooCode ==47){text_layer_set_text(IconLayer,"O");} //isolated thundershowers
}
